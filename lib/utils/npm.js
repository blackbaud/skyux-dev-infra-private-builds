...
exports.getDistTags = exports.getVersion = exports.checkVersionExists = exports.getVersions = void 0;
...
async function checkVersionExists(packageName, version) {
    return getVersion(packageName).then((npmVersion) => npmVersion === version);
}
