...
exports.unsetCommitter = exports.setCommitter = exports.push = exports.commit = exports.getRemoteUrl = exports.getLastCommit = exports.isClean = exports.getCurrentBranch = exports.fetchAll = exports.checkoutNewBranch = exports.remove = exports.addAll = void 0;
...
async function getRemoteUrl(config) {
    ...
    const remote = (await (0, spawn_1.getCommandOutput)('git', [
        '-C',
        options.workingDirectory,
        'remote',
    ])) || '';
